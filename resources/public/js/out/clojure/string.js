...
{{
var G__10436 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10436;
continue;
}
} else
...
{var pred__10440 = cljs.core._EQ_;var expr__10441 = limit;if(cljs.core.truth_(pred__10440.call(null,1,expr__10441)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10440.call(null,2,expr__10441)))
...
var G__10443 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10444 = (limit__$1 - 1);
var G__10445 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10443;
limit__$1 = G__10444;
parts = G__10445;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10447 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10447))
{var replacement_10448 = temp__4090__auto___10447;buffer.append([cljs.core.str(replacement_10448)].join(''));
} else
{buffer.append(ch);
}
{
