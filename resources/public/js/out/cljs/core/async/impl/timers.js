...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13319 = 0;while(true){
if((i_13319 < arr.length))
{(arr[i_13319] = null);
{
var G__13320 = (i_13319 + 1);
i_13319 = G__13320;
continue;
}
} else
...
{var i_13326 = (self__.level + 1);while(true){
if((i_13326 <= (new_level + 1)))
{(update[i_13326] = self__.header);
{
var G__13327 = (i_13326 + 1);
i_13326 = G__13327;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13328 = 0;while(true){
if((i_13328 <= self__.level))
{var links_13329 = (update[i_13328]).forward;if(((links_13329[i_13328]) === x__$1))
{(links_13329[i_13328] = (x__$1.forward[i_13328]));
{
