...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13354 = 0;while(true){
var m_13355 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13355 == null))
{} else
{m_13355.call(null);
if((count_13354 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13356 = (count_13354 + 1);
count_13354 = G__13356;
continue;
}
} else
{}
