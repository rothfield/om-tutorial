...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13360 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13360 = (function (val,box,meta13361){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13360.cljs$lang$type = true;
cljs.core.async.impl.channels.t13360.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13360";
cljs.core.async.impl.channels.t13360.cljs$lang$ctorPrWriter = (function (this__3956__auto__,writer__3957__auto__,opt__3958__auto__){return cljs.core._write.call(null,writer__3957__auto__,"cljs.core.async.impl.channels/t13360");
});
cljs.core.async.impl.channels.t13360.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13360.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13362){var self__ = this;
var _13362__$1 = this;return self__.meta13361;
});
cljs.core.async.impl.channels.t13360.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13362,meta13361__$1){var self__ = this;
var _13362__$1 = this;return (new cljs.core.async.impl.channels.t13360(self__.val,self__.box,meta13361__$1));
});
cljs.core.async.impl.channels.__GT_t13360 = (function __GT_t13360(val__$1,box__$1,meta13361){return (new cljs.core.async.impl.channels.t13360(val__$1,box__$1,meta13361));
});
}
return (new cljs.core.async.impl.channels.t13360(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13363 = self__.takes.pop();if((taker_13363 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13363))
{var take_cb_13364 = cljs.core.async.impl.protocols.commit.call(null,taker_13363);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13364,taker_13363){
return (function (){return take_cb_13364.call(null,null);
});})(take_cb_13364,taker_13363))
);
} else
{}
{
